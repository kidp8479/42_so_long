...
/*   Updated: 2025/07/25 00:36:08 by pafroidu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
	Bonus version of get_next_line:
	Supports multiple file descriptors by storing one static buffer per fd
	using a static array: static char *rest[FD_MAX].

	Each call to get_next_line(fd) reads and updates rest[fd] independently,
	allowing simultaneous line-by-line reading from multiple sources.

	Logic and structure are identical to the mandatory version.
